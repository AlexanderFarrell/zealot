...
pub trait AttributeRepo: Debug + Send + Sync {
     ...
     fn add_attribute_kind(&self, dto: &AddAttributeKindDto, account_id: &Id) -> Result<Option<AttributeKind>, RepoError>;
     fn update_attribute_kind(&self, dto: &UpdateAttributeKindDto, account_id: &Id) -> Result<Option<AttributeKind>, RepoError>;
