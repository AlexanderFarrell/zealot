...
use zealot_domain::{common::id::Id, item_type::{AddItemTypeDto, ItemType, UpdateItemTypeDto}};
...
pub trait ItemTypeRepo: Debug + Send + Sync {
    ...
    fn add_attr_kinds_to_item_type(&self, attr_kinds: &Vec<String>, item_type_id: &Id, account_id: &Id) -> Result<(), RepoError>;
    fn remove_attr_kinds_from_item_type(&self, attr_kinds: &Vec<String>, item_type_id: &Id, account_id: &Id) -> Result<(), RepoError>;
}
