...
use zealot_domain::{comment::{AddCommentDto, Comment, UpdateCommentDto}, common::id::Id};
...
pub trait CommentRepo: Debug + Send + Sync {
    ...
    fn add_comment(&self, dto: &AddCommentDto, account_id: &Id) -> Result<Option<Comment>, RepoError>;
    fn update_comment(&self, dto: &UpdateCommentDto, account_id: &Id) -> Result<Option<Comment>, RepoError>;
