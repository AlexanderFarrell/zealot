...
use crate::repos::sqlite::{
    ...
    session_sqlite::SessionSqliteRepo, statistic_sqlite::StatisticSqliteRepo,
    time_block_sqlite::TimeBlockSqliteRepo,
};
...
pub fn get_sqlite_repos(pool: SqlitePool) -> ZealotRepos {
    ZealotRepos {
        ...
        statistic: Arc::new(StatisticSqliteRepo::new(pool.clone())),
