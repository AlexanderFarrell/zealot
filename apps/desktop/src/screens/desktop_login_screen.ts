interface DesktopLoginOpts {
    onLogin: (username: string, password: string) => Promise<void>;
}

export class DesktopLoginScreen extends HTMLElement {
    private opts: DesktopLoginOpts | null = null;

    init(opts: DesktopLoginOpts): this {
        this.opts = opts;
        this.render();
        return this;
    }
    ...
    private render(): void {
        ...
        <form id="login_form" class="inner_window">
            ...
            <label for="desk_username">Username</label>
            <input
                type="text"
                id="desk_username"
                name="username"
                ...
                spellcheck="false"
            >
            <label for="desk_password">Password</label>
            <input
                type="password"
                id="desk_password"
                name="password"
...
customElements.define('desktop-login-screen', DesktopLoginScreen);
